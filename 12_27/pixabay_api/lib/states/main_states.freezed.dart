...
/// @nodoc
mixin _$MainState {
  List<Hits> get imagedata => throw _privateConstructorUsedError;
...
class _$MainStateImpl implements _MainState {
  const _$MainStateImpl({final List<Hits> imagedata = const []})
      : _imagedata = imagedata;

  factory _$MainStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$MainStateImplFromJson(json);

  final List<Hits> _imagedata;
  @override
  @JsonKey()
  List<Hits> get imagedata {
  ...
  @override
  String toString() {
    return 'MainState(imagedata: $imagedata)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(_imagedata));
...
abstract class _MainState implements MainState {
  const factory _MainState({final List<Hits> imagedata}) = _$MainStateImpl;
